...
class DetailTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getConsumerUnity()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setConsumerUnity()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getOccurrence()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setOccurrence()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getParcel()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setParcel()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getAuthorization()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setAuthorization()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getDealership()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setDealership()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getClient()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setClient()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getSequence()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setSequence()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::getPurchaser()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Received\Partial\Detail::setPurchaser()
     */
