...
class HeaderTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::getCustomer()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::setCustomer()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::getCreated()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::setCreated()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::getSequence()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::setSequence()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::__construct()
     * @covers \MrPrompt\Centercob\Gateway\Shipment\Partial\Header::render()
     */
