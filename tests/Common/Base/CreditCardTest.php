...
class CreditCardTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::getNumber()
     */
     ...
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::setNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::getValidate()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::setValidate()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::getSecurityNumber
     */
     ...
     * @dataProvider loadCardsProvider
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::setSecurityNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::getFlag()
     */
     ...
     * @dataProvider loadCardsProvider
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\CreditCard::setFlag()
     */
