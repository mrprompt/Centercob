...
class ConsumerUnityTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::getNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::setNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::getRead()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::setRead()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::getMaturity()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\ConsumerUnity::setMaturity()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\Consumerunity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\Consumerunity::getCode()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\Consumerunity::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\Consumerunity::setCode()
     * @covers \MrPrompt\Centercob\Common\Base\Consumerunity::getCode()
     */
