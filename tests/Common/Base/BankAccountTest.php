...
class BankAccountTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::getNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::getDigit()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::getOperation()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::getBank()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::getSecurity()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::getHolder()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::setNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::setDigit()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::setOperation()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::setSecurity()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::setBank()
     */
     ...
     * @test
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Centercob\Common\Base\BankAccount::setHolder()
     */
